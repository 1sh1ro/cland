...
const en: Dictionary = {
  ...
  "settings.systemPrompt": "Task System Prompt",
  "settings.systemPromptHint": "Placeholders: {{timezone}}, {{workDayStart}}, {{workDayEnd}}",
...
const zh: Dictionary = {
  ...
  "settings.apiKey": "API Key",
  "settings.systemPrompt": "任务系统提示词",
  "settings.systemPromptHint": "可用占位符：{{timezone}}、{{workDayStart}}、{{workDayEnd}}",
