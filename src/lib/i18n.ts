...
const en: Dictionary = {
  ...
  "nl.parsing": "Parsing...",
  "nl.explain": "Explain Plan",
  "nl.explaining": "Explaining...",
  "nl.explainTitle": "Plan Explanation",
  "nl.noExplanation": "No explanation available.",
  "tasks.title": "Tasks",
  "tasks.empty": "No tasks yet.",
  "tasks.remove": "Remove",
  "tasks.addToCalendar": "Add to schedule",
  "tasks.generatePlan": "One-click plan",
  "tasks.prev": "Prev",
  "tasks.next": "Next",
  ...
  "taskForm.advancedShow": "Show advanced",
  "taskForm.advancedHide": "Hide advanced",
  ...
  "calendar.difficulty": "Difficulty",
  "calendar.difficultyLow": "Low",
  "calendar.difficultyMedium": "Medium",
  "calendar.difficultyHigh": "High",
  "calendar.clearLocks": "Clear locks",
  "sidebar.title": "Sidebar",
  "sidebar.collapse": "Collapse",
  "sidebar.expand": "Expand",
  "sticky.exit": "Full view",
  "sticky.noTaskTitle": "No active task",
  "sticky.noTime": "No active time",
  "sticky.tip": "AI Tip",
  "sticky.tipLoading": "Generating...",
  "sticky.tipPlaceholder": "Tip will appear here.",
  "sticky.tipDisabled": "AI tips are disabled.",
  "sticky.tipNeedKey": "Add API key to get tips.",
  "sticky.tipFailed": "Tip request failed.",
  "sticky.alwaysOnTop": "Always on top",
  "memo.title": "Memo",
  ...
  "knowledge.emptyAction": "Add a new entry",
  "knowledge.view": "View",
  ...
  "settings.stickyMode": "Sticky note mode",
  "settings.alwaysOnTop": "Always on top",
  "settings.tips": "AI tips",
  "settings.stickyHint": "Sticky mode shows only the current task.",
  "settings.systemPrompt": "Custom Planning Notes",
  "settings.systemPromptPlaceholder": "Example: I focus best in the morning, avoid Friday afternoons.",
  "settings.systemPromptHint": "These notes are appended to the system prompt.",
  ...
  "status.noPlan": "Generate a plan first.",
  ...
  "status.taskNotScheduledReason": "Cannot schedule: {reason}",
  "status.taskScheduled": "Added to schedule ({count} blocks).",
  "status.taskAlreadyScheduled": "Task is already scheduled.",
  "status.taskNotScheduled": "No available time for this task.",
  "status.reason.completed": "Task already completed.",
  "status.reason.deadlinePassed": "Deadline has already passed.",
  "status.reason.deadlineConflict": "Earliest start is after the deadline.",
  "status.reason.dailyLimit": "Daily limit {limit} min is below minimum block {min} min.",
  "status.reason.workHours": "Working hours leave no available time.",
  "status.reason.horizon": "Planning window has {capacity} min for {needed} min needed.",
  "status.reason.noFreeSlots": "No free slots (busy events or locked blocks).",
...
const zh: Dictionary = {
  ...
  "nl.explain": "查看原因",
  "nl.explaining": "生成中...",
  "nl.explainTitle": "计划原因",
  "nl.noExplanation": "暂无原因说明。",
  "tasks.title": "任务列表",
  "tasks.empty": "还没有任务。",
  "tasks.remove": "移除",
  "tasks.addToCalendar": "加入日程",
  "tasks.generatePlan": "一键生成",
  "tasks.prev": "上一页",
  "tasks.next": "下一页",
  ...
  "taskForm.cancel": "取消",
  "taskForm.clear": "清空",
  "taskForm.advancedShow": "展开高级",
  "taskForm.advancedHide": "收起高级",
  "busy.title": "忙碌事件",
  ...
  "calendar.title": "日程视图",
  "calendar.weekView": "一周",
  "calendar.focusView": "近三天",
  "calendar.morning": "上午",
  "calendar.afternoon": "下午",
  "calendar.evening": "晚上",
  "calendar.empty": "暂无安排",
  "calendar.inProgress": "进行中",
  "calendar.upcoming": "待开始",
  "calendar.difficulty": "难度",
  "calendar.difficultyLow": "低",
  "calendar.difficultyMedium": "中",
  "calendar.difficultyHigh": "高",
  "calendar.clearLocks": "清除锁定",
  "sidebar.title": "侧边栏",
  "sidebar.collapse": "收起",
  "sidebar.expand": "展开",
  "sticky.exit": "返回完整视图",
  "sticky.noTaskTitle": "暂无进行中任务",
  "sticky.noTime": "暂无进行中时间",
  "sticky.tip": "AI 提示",
  "sticky.tipLoading": "生成中...",
  "sticky.tipPlaceholder": "提示会显示在这里。",
  "sticky.tipDisabled": "AI 提示已关闭。",
  "sticky.tipNeedKey": "请先填写 API Key。",
  "sticky.tipFailed": "AI 提示生成失败。",
  ...
  "settings.stickyMode": "便签模式",
  "settings.alwaysOnTop": "窗口置顶",
  "settings.tips": "AI 提示",
  "settings.stickyHint": "便签模式仅展示当前任务。",
  "settings.systemPrompt": "个人规划偏好",
  "settings.systemPromptPlaceholder": "例如：上午效率高，周五下午尽量不排任务。",
  "settings.systemPromptHint": "该内容会追加到系统提示词中。",
  "settings.hint": "API 设置仅保存在本地。",
  "status.addTaskPrompt": "请先添加至少一个任务再生成计划。",
  "status.planGenerated": "计划生成于 {time}。",
  "status.noPlan": "请先生成计划。",
  "status.parseEnter": "请输入任务文本后再解析。",
  "status.parsing": "正在解析任务...",
  "status.parsed": "已解析 {count} 个任务。",
  "status.parseFailed": "解析任务失败。",
  "status.taskNotScheduledReason": "无法加入日程：{reason}",
  "status.taskScheduled": "已加入日程（{count} 个块）。",
  "status.taskAlreadyScheduled": "该任务已在日程中。",
  "status.taskNotScheduled": "当前无法安排该任务。",
  "status.reason.completed": "任务已完成。",
  "status.reason.deadlinePassed": "截止时间已过。",
  "status.reason.deadlineConflict": "最早开始晚于截止时间。",
  "status.reason.dailyLimit": "每日上限 {limit} 分钟低于最小块 {min} 分钟。",
  "status.reason.workHours": "工作时间内没有可用时段。",
  "status.reason.horizon": "规划期内可用 {capacity} 分钟，需求 {needed} 分钟。",
  "status.reason.noFreeSlots": "无可用时间（忙碌事件或锁定块占满）。",
